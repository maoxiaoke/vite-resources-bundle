...
var HelloWorld_vue_vue_type_style_index_0_scoped_true_lang = "\na[data-v-9ba5e0a8] {\n  color: #42b983;\n}\nlabel[data-v-9ba5e0a8] {\n  margin: 0 0.5em;\n  font-weight: bold;\n}\ncode[data-v-9ba5e0a8] {\n  background-color: #eee;\n  padding: 2px 4px;\n  border-radius: 4px;\n  color: #304455;\n}\n";
const _withId = /* @__PURE__ */ withScopeId("data-v-9ba5e0a8");
pushScopeId("data-v-9ba5e0a8");
const _hoisted_1$1 = /* @__PURE__ */ createStaticVNode('<p data-v-9ba5e0a8> Recommended IDE setup: <a href="https://code.visualstudio.com/" target="_blank" data-v-9ba5e0a8>VSCode</a> + <a href="https://marketplace.visualstudio.com/items?itemName=octref.vetur" target="_blank" data-v-9ba5e0a8> Vetur </a> or <a href="https://github.com/johnsoncodehk/volar" target="_blank" data-v-9ba5e0a8>Volar</a> (if using <code data-v-9ba5e0a8>&lt;script setup&gt;</code>) </p><p data-v-9ba5e0a8>See <code data-v-9ba5e0a8>README.md</code> for more information.</p><p data-v-9ba5e0a8><a href="https://vitejs.dev/guide/features.html" target="_blank" data-v-9ba5e0a8> Vite Docs </a> | <a href="https://v3.vuejs.org/" target="_blank" data-v-9ba5e0a8>Vue 3 Docs</a></p>', 3);
...
_sfc_main$1.__scopeId = "data-v-9ba5e0a8";
...
const _hoisted_1 = /* @__PURE__ */ createVNode("img", {
  alt: "Vue logo",
  src: _imports_0
}, null, -1);
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Fragment, null, [
    _hoisted_1,
    createVNode(_component_HelloWorld, { msg: "Hello Vue 3 + TypeScript + Vite" })
  ], 64);
}
...
cache.getCache = cache.setCache = void 0;
...
Object.defineProperty(isInIcestark$1, "__esModule", { value: true });
var cache_1$1 = cache;
var isInIcestark = function() {
  return !!cache_1$1.getCache("root");
};
var _default$1 = isInIcestark$1.default = isInIcestark;
var setLibraryName$1 = {};
Object.defineProperty(setLibraryName$1, "__esModule", { value: true });
var cache_1 = cache;
var setLibraryName = function(library) {
  if (!library) {
    console.error("[@ice/stark-app] setLibraryName: params can not be empty!");
    return;
  }
  cache_1.setCache("library", library);
};
var _default = setLibraryName$1.default = setLibraryName;
let vue = null;
if (!_default$1()) {
